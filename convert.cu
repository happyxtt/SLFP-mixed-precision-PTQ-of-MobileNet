...
using namespace std;
using std::cout;
//浮点数转sfp<4,5> 或 sfp<4,3>   type = 尾数位
__device__ sfp float2sfp(float a, int type)  //modified
  {
    myfixed reg;
    myfixed regFixed;
    sfp out;
...
//sfp乘法（基于查找表）
__device__ float sfp2fixed(sfp active, sfp weight, int type) //modified
  {
    lut regMult;
...
__device__ float sfp2float( sfp a)
  {
    ...
    switch (a.mnt)
      {
        case 0:      out = 1.000000;  break;
        case 1:      out = 1.031250;  break;
        case 2:      out = 1.062500;  break;
        case 3:      out = 1.093750;  break;
        case 4:      out = 1.125000;  break;
        case 5:      out = 1.156250;  break;
        case 6:      out = 1.187500;  break;
        case 7:      out = 1.218750;  break;
        case 8:      out = 1.250000;  break;
        case 9:      out = 1.281250;  break;
        case 10:      out = 1.312500;  break;
        case 11:      out = 1.343750;  break;
        case 12:      out = 1.375000;  break;
        case 13:      out = 1.406250;  break;
        case 14:      out = 1.437500;  break;
        case 15:      out = 1.468750;  break;
        case 16:      out = 1.500000;  break;
        case 17:      out = 1.531250;  break;
        case 18:      out = 1.562500;  break;
        case 19:      out = 1.593750;  break;
        case 20:      out = 1.625000;  break;
        case 21:      out = 1.656250;  break;
        case 22:      out = 1.687500;  break;
        case 23:      out = 1.718750;  break;
        case 24:      out = 1.750000;  break;
        case 25:      out = 1.781250;  break;
        case 26:      out = 1.812500;  break;
        case 27:      out = 1.843750;  break;
        case 28:      out = 1.875000;  break;
        case 29:      out = 1.906250;  break;
        case 30:      out = 1.937500;  break;
        case 31:      out = 1.968750;  break;   
      }
    ...
    else
    {
      switch (a.exp)
          {
            case 1:     out = out * 0.0078125;   break;
            case 2:     out = out * 0.015625;    break;
            case 3:     out = out * 0.03125;     break;
            case 4:     out = out * 0.0625;      break;
            case 5:     out = out * 0.125;       break;
            case 6:     out = out * 0.25;        break; 
            case 7:     out = out * 0.50;        break;
            case 8:     out = out * 1;           break;
            case 9:     out = out * 2;           break;
            case 10:    out = out * 4;           break;
            case 11:    out = out * 8;           break;
            case 12:    out = out * 16;          break; 
            case 13:    out = out * 32;          break;
            case 14:    out = out * 64;          break;
            case 15:    out = out * 128;         break; 
          }
    }

    //根据符号位判断正负
    out = (a.sign == 1)?(-out):out;

    return out;
  }


float sfpfloat( sfp a)   //测试用的
  {
    float out;
    //求尾数
    switch (a.mnt)
